...
func (u UserAccessService) GetList(param params.AccessLogGetParam) (*[]mongoModel.UserAccessLog, int64) {
	...
	dateStart := time.Unix(param.DateStart, 0).Local()
	dateEnd := time.Unix(param.DateEnd, 0).Local()
